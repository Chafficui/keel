...
/**
 * create-keel CLI (a codai project)
 *
 * Scaffolds a new project from the keel template with a comprehensive
 * interactive wizard covering project configuration, database, email, storage,
 * authentication, Capacitor platforms, and sails.
 *
 * Usage:
...
async function main(): Promise<void> {
  ...
  // Parse CLI args -- first positional argument is the project name
